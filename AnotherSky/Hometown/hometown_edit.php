...
<br>
<div class="macro">
    <form action="hometown_edit(b).php?post_id=<?php echo $post_id ?>" method="post" enctype="multipart/form-data">
        <?php echo $post["date"] ?>
        <br><br>
        title <br>
            ...
            '<div class="spot-container">
                ...
                <div class="image-preview-container">';
                    ...
                    if(isset($post["images"][$c_image]) && $post["images"][$c_image]["image_order"] == $i) {
                        $image_path = $post["images"][$c_image]["path"];
                        echo 
                    '<img src="'.$post["images"][$c_image]["path"].'">';
                ...
                <input type="file" name="post_image[]" accept="image/*" value onchange="showImagePreview(this)">
